  ...
  document.getElementById("navbar").innerHTML += '<nav class="items-baseline relative bg-black w-full flex flex-wrap items-center justify-between py-2">\n' +
        ...
        '            <a href="/RequeteApi.html" class="text-center no-underline  border-b-4 border-white mx-3 py-2 m-2 sm:inline-block hover:bg-gray-800  hover:border-blue-600" >Connexion</a>\n' +
        '\n' +
        '        </div>\n' +
        '    </div>\n' +
        '</nav></div>';
